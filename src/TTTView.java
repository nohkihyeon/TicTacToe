...
public class TTTView extends BorderPane {
	...
	private TTTPresenter thePresenter;
	public TTTView() {
	...
	public void setPresenter(TTTPresenter thePresenter) {
		this.thePresenter = thePresenter;
	}
	public void clear() {
		for(int r=0; r<3; r++)
			for(int c=0; c<3; c++)
